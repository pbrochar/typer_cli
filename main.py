...
app = typer.Typer(help="Sort, invert letters or define words in a string")


@app.command(help="Sort the words in the string.")
def sort(
...
@app.command(help="Invert the first two letters of each word in the string.")
...
@app.command(help="Define, if possible, each word in the sentence.")
